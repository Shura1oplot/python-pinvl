...
This project is a fork of the python module `trafaret
<https://github.com/Deepwalker/trafaret>`_.

Main changes:

* Lots of code refactoring and cleaning up
* ``Dict`` is changed (see code and examples)
* Old experimental code is removed

Read original `README.rst
<https://github.com/Deepwalker/trafaret/blob/master/README.rst>`_ below.
